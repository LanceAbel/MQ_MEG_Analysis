...
%for j=1:length(txtfiles)
    ...
    if TF==0
        ...
        % Fit HGF
        est_tones_hgf_whatworld = tapas_fitModel([], to_fit_to_hgf, 'tapas_hgf_whatworld_config', 'tapas_bayes_optimal_whatworld_config');
        % Write HGF output
    
        HGF_name = ' HGF_Original ';
        ...
        save(hgf_savename,  'est_tones_hgf_whatworld');  
        for i = 2:length(est_tones_hgf_whatworld.u_orig)
...
%         
%         % Fit HGF
%         est_tones_hgf_whatworld = tapas_fitModel([], tones, 'tapas_hgf_whatworld_config', 'tapas_bayes_optimal_whatworld_config')
%         % Write HGF output
%     
%         HGF_name = 'HGF';
%         SeqLength = num2str(NUM_TONES_LONG);
%         Ext = '.mat';
%         hgf_savename = strcat(HGF_name, SeqLength);
%         hgf_savename = strrep(hgf_savename, '.txt', '.mat');
%         hgf_savename = strrep(hgf_savename, '.mat', '');
%         hgf_savename = strcat(hgf_savename, '.mat');
%     
%         hgf_savename2 = strrep(hgf_savename, '.mat', '_mod.mat');
%         %save(hgf_savename,  'est_tones_hgf_whatworld');  
%         save(hgf_savename2,  'est_tones_hgf_whatworld');  
% 
%         for i = 2:length(est_tones_hgf_whatworld.u_orig)
% 
%            stim_before  = est_tones_hgf_whatworld.u_orig(i-1);
...
%         newtxtfile_name = strrep(hgf_savename, Ext, '');
%         %newtxtfile_name = strcat(newtxtfile_name, ' PE2.txt');
%         newtxtfile_name = strcat(newtxtfile_name, ' PE2_mod.txt');
...
%         newtxtfile_name = strrep(hgf_savename, Ext, '');
%         %newtxtfile_name = strcat(newtxtfile_name, ' PWPE2.txt');
%         newtxtfile_name = strcat(newtxtfile_name, ' PWPE2_mod.txt');
